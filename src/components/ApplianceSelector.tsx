...
const appliancesByRoom: Record<string, { id: string; name: string; description: string }[]> = {
  kitchen: [
    ...
    { id: "kitchen-cabinets", name: "Modern Cabinets", description: "Soft-close hinges" },
    { id: "kitchen-island", name: "Kitchen Island", description: "With breakfast bar" },
    { id: "pantry-storage", name: "Pantry System", description: "Pull-out shelves" },
    { id: "garbage-disposal", name: "Garbage Disposal", description: "Quiet InSinkErator" },
    { id: "water-filtration", name: "Water Filtration", description: "Under-sink system" },
    { id: "pot-filler", name: "Pot Filler Faucet", description: "Wall-mounted" },
    { id: "drawer-organizers", name: "Drawer Organizers", description: "Custom inserts" },
    { id: "under-cabinet-lights", name: "Under Cabinet Lights", description: "LED strips" },
  ],
  bedroom: [
  ...
  exterior: [
    { id: "garage-door", name: "Smart Garage Door", description: "App controlled" },
    { id: "garage", name: "Garage", description: "Storage & parking" },
    { id: "conservatory", name: "Conservatory", description: "Glass extension" },
    { id: "storey-extension", name: "Storey Extension", description: "Additional floor" },
    { id: "fence", name: "Privacy Fence", description: "Modern wood/metal" },
    { id: "grille-gate", name: "Grille Gate", description: "Security entrance" },
    { id: "balcony", name: "Balcony", description: "Railing & flooring" },
    { id: "patio", name: "Patio", description: "Paved outdoor area" },
    { id: "patio-furniture", name: "Patio Furniture", description: "Weather resistant set" },
    { id: "patio-heater", name: "Patio Heater", description: "Infrared warmth" },
    { id: "deck", name: "Wooden Deck", description: "Composite decking" },
    { id: "driveway", name: "Driveway", description: "Paved or gravel" },
    { id: "carport", name: "Carport", description: "Covered parking" },
    { id: "porch", name: "Front Porch", description: "Covered entrance" },
    { id: "exterior-lighting", name: "Exterior Lighting", description: "Security & accent" },
    { id: "outdoor-speakers", name: "Outdoor Speakers", description: "Weather resistant" },
    { id: "cladding", name: "Wall Cladding", description: "Exterior finish" },
    { id: "roof", name: "Roof Upgrade", description: "Modern materials" },
  ],
  garden: [
    { id: "landscaping", name: "Landscaping", description: "Professional design" },
    { id: "lawn", name: "Lawn", description: "Turf or artificial" },
    { id: "flower-beds", name: "Flower Beds", description: "Planted borders" },
    { id: "trees", name: "Trees & Shrubs", description: "Mature planting" },
    { id: "garden-path", name: "Garden Path", description: "Stone or gravel" },
    { id: "garden-lighting", name: "Garden Lights", description: "Solar powered" },
    { id: "irrigation", name: "Smart Irrigation", description: "Auto watering" },
    { id: "pergola", name: "Pergola", description: "Shade structure" },
    { id: "gazebo", name: "Gazebo", description: "Garden shelter" },
    { id: "garden-shed", name: "Garden Shed", description: "Storage building" },
    { id: "greenhouse", name: "Greenhouse", description: "Plant growing" },
    { id: "pond", name: "Garden Pond", description: "Water feature" },
    { id: "fountain", name: "Fountain", description: "Decorative water" },
    { id: "fire-pit", name: "Fire Pit", description: "Propane or wood" },
    { id: "outdoor-kitchen", name: "Outdoor Kitchen", description: "Full cooking station" },
    { id: "grill", name: "Smart Grill", description: "WiFi temperature" },
    { id: "pool", name: "Swimming Pool", description: "In-ground pool" },
    { id: "hot-tub", name: "Hot Tub", description: "Spa jets" },
    { id: "pool-equipment", name: "Pool Equipment", description: "Auto cleaning" },
    { id: "vegetable-garden", name: "Vegetable Garden", description: "Raised beds" },
    { id: "compost-bin", name: "Compost Bin", description: "Eco recycling" },
    { id: "garden-furniture", name: "Garden Furniture", description: "Seating area" },
  ],
};
